...
loop: while (true) {
  ...
  switch (animalFace) {
    case "LEFT":
      nextChar = input[currPosY][currPosX - 1];
      if (["7", "|", ".", "J"].includes(nextChar) || currPosX - 1 < 0) {
        animalFace = "TOP";
        continue loop;
      }
      break;
    case "RIGHT":
      ...
      if (
        ...
        currPosX + 1 >= input[currPosY].length
      ) {
        animalFace = "BOTTOM";
        continue loop;
      }
      break;
    case "TOP":
      nextChar = input[currPosY - 1][currPosX];
      if (["L", "-", ".", "J"].includes(nextChar) || currPosY - 1 < 0) {
        animalFace = "RIGHT";
        continue loop;
      }
      break;
    case "BOTTOM":
      nextChar = input[currPosY + 1][currPosX];
      if (
        ["-", "7", "F", "."].includes(nextChar) ||
        currPosY + 1 >= input.length
      ) {
        animalFace = "LEFT";
        continue loop;
      }
